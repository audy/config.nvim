...
vim.keymap.set('n', '<leader>fq', builtin.quickfix, { desc = "Telescope [f]ind [q]uickfix" })
vim.keymap.set('n', '<leader>fg', builtin.live_grep, { desc = 'Telescope live [g]rep' })
vim.keymap.set('n', '<leader>gf', function()
  require('telescope.builtin').live_grep({
    glob_pattern = '*.' .. vim.fn.expand('%:e')
  })
end, { desc = 'Telescope live [g]rep current [f]iletype' })
vim.keymap.set('n', '<leader>fo', builtin.oldfiles, { desc = 'Telescope [o]ld [f]iles' })
vim.keymap.set('n', '<leader>fb', builtin.buffers, { desc = 'Telescope buffers' })
vim.keymap.set('n', '<leader>fh', builtin.help_tags, { desc = 'Telescope help tags' })
vim.keymap.set('n', '<leader>fk', builtin.keymaps, { desc = 'Telescope keymaps' })
vim.keymap.set('n', '<leader>fs', builtin.spell_suggest, { desc = 'Telescope spelling' })
